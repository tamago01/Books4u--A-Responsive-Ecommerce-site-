...
if(isset($_POST['order_btn'])){
   ...
   $order_query = mysqli_query($conn, "SELECT * FROM `orders` WHERE name = '$name' AND number = '$number' AND email = '$email' AND method = '$method' AND address = '$address' AND total_products = '$total_products' AND total_price = '$cart_total'") or die('query failed');
       $update_quantity=   mysqli_query($conn,"UPDATE `products` SET quantity=quantity-'".$item_quantity."' WHERE name='".$item_name."'");
       $update_sold= mysqli_query($conn,"UPDATE `products` SET sold=sold+'".$item_quantity."' WHERE name='".$item_name."'");
   ...
   if($cart_total == 0){
    ...
    switch ($select_option) {
        ...
        $message[] = 'Order placed, please pay from eSewa scanning the QR and mentioning your email'; 
   ...
   <form action="" method="post">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="text" name="street" required placeholder="e.g. Street 19A">
         </div>
         <div class="inputBox">
            <span>city :</span>
            <select name="City">
            ...
            <option value="5">Jhapa</option>
            <option value="6">Lumbini</option>
            <option value="7">Chitwan</option>
            </select>
         </div>
         <div class="inputBox">
            <span>state :</span>
            ...
            <option value="3">Province No.1</option>
      ...
      <a href="indx.php"><input type="submit" value="order now" class="btn" name="order_btn"> </a>
   </form>
